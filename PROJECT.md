...
| 前台组件库 | shadcn/ui（基于Radix UI + Tailwind） | 官网前台页面 |
| CMS组件库 | Ant Design v5 | Strapi自定义插件/扩展 |
...
| 你要做的事 | 读哪个文档 |
|-----------|-----------|
| 理解业务全貌 | `docs/需求文档.html` |
| 前台页面功能细节 | `docs/执行文件.html` |
...
- 🏠 仪表盘（定制待办汇总：新线索/未处理工单/待发布内容）
- 👤 账号管理（超管专用：创建/停用后台账号，分配角色）
...
| Phase | 名称 | 文件 | 状态 |
|-------|------|------|------|
| 0 | 项目初始化 | 施工计划.md | ✅ 完成 (2026-03-15) |
| 1 | 前台页面开发 | 施工计划.md | ⬜ 未开始 |
| 2 | 全局功能 | 施工计划.md | ⬜ 未开始 |
| 3 | SEO/Metadata | 施工计划.md | ⬜ 未开始 |
| 4 | CMS后台 | 施工计划.md | ⬜ 未开始 |
| 5 | 表单与通知 | 施工计划.md | ⬜ 未开始 |
| 6 | 性能优化 | 施工计划.md | ⬜ 未开始 |
| 7 | 安全加固 | 施工计划.md | ⬜ 未开始 |
...
> 需求文档和后端技术规范当前写的是阿里云，PROJECT.md之前误写了AWS。
