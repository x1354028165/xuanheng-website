...
export default function Products() {
  ...
  return (
    <div>
      ...
      <Drawer title={t('products.editProduct')} open={drawerOpen} onClose={() => setDrawerOpen(false)} width={520}
        ...
        <Form form={form} layout="vertical">
          ...
          <Form.Item name="coverUrl" label={t('products.coverImage')}><Input /></Form.Item>
        </Form>
      </Drawer>
    </div>
  );
