...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      <section className="bg-[#F8FAFC] py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <h2 className="mb-8 text-center text-2xl font-bold text-[#0F172A]">{tc('contactUs')}</h2>
          <div className="grid gap-8 sm:grid-cols-3">
            <div className="flex flex-col items-center rounded-2xl border border-[#E2E8F0] bg-white p-8 text-center shadow-sm">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#1A3FAD]/10 text-[#1A3FAD]">
              ...
              <h3 className="mt-4 font-semibold text-[#0F172A]">{tc('address')}</h3>
              <p className="mt-2 text-sm text-[#475569]">{t_contact('info.address')}</p>
            </div>
            <div className="flex flex-col items-center rounded-2xl border border-[#E2E8F0] bg-white p-8 text-center shadow-sm">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#1A3FAD]/10 text-[#1A3FAD]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" /></svg>
              </div>
              <h3 className="mt-4 font-semibold text-[#0F172A]">{tc('phone')}</h3>
              <p className="mt-2 text-sm text-[#475569]">{t_contact('info.phone')}</p>
            </div>
            <div className="flex flex-col items-center rounded-2xl border border-[#E2E8F0] bg-white p-8 text-center shadow-sm">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#1A3FAD]/10 text-[#1A3FAD]">
              ...
              <h3 className="mt-4 font-semibold text-[#0F172A]">{tc('email')}</h3>
              <p className="mt-2 text-sm text-[#475569]">{t_contact('info.email')}</p>
            </div>
          </div>
        </div>
      </section>
