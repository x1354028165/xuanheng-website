...
export default async function ContactPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const contacts = [
    { name: t('person1Name'), title: t('person1Title'), email: t('person1Email'), phone: t('person1Phone') },
    { name: t('person2Name'), title: t('person2Title'), email: t('person2Email'), phone: t('person2Phone') },
    { name: t('person3Name'), title: t('person3Title'), email: t('person3Email'), phone: t('person3Phone') },
  ];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 shadow-sm">
              <ContactForm
                labels={{
                  name: t('form.name'), company: t('form.company'), phone: t('form.phone'),
                  email: t('form.email'), intent: t('form.intent'),
                  intentOptions: {
                    integrator: t('form.intentOptions.integrator'), api: t('form.intentOptions.api'),
                    hardware: t('form.intentOptions.hardware'), custom: t('form.intentOptions.custom'),
                    other: t('form.intentOptions.other'),
                  },
                  message: t('form.message'), submit: t('form.submit'),
