...
export const MOCK_PRODUCTS: MockProduct[] = [
  {
    ...
    positioning: '通用多协议网关',
    slug: 'neuron-ii',
    tagline: '多协议智能网关，支持 4G/WiFi/RS485/CAN，适用 200+ 国家或地区',
    category: 'hardware',
    description: 'Neuron II 是旭衡电子的通用多协议智能网关，支持 4G、WiFi、有线通信及多协议，可通过拓展模块增强功能，适用 200+ 国家或地区，广泛应用于储能、光伏、电能质量等多种场景。',
    specs: {
      '处理器': 'T113-i, 1.1GHz',
      '内存': '512MB DDR3',
      '存储': '4GB eMMC',
      ...
      '网口': '1 × 10/100M RJ45',
      '无线': '蓝牙 5.0，WiFi',
      '4G': '中国移动/联通/电信 4G 全网通',
      '安装方式': '壁挂式安装',
      '供电': 'DC 12V（输入范围 DC 11V–12V）',
      '功耗': '20W',
      '工作温度': '-40°C ~ +85°C',
      '湿度': '5%～95%（无凝露）',
      '尺寸': '145 × 157.5 × 17 mm',
  ...
  },
  {
    ...
    slug: 'neuron-iii',
    tagline: '新一代智能控制器网关，自带电表与显示屏，支持多桩 DLB 动态负载均衡',
    category: 'hardware',
    description: 'Neuron III 是新一代智能控制器网关，自带电表与 LCD 显示屏，支持 PLC/4G/WiFi/以太网/蓝牙多种通信方式，实时最大充电电流控制，支持多桩动态负载均衡（DLB），适配光伏、储能、充电桩等多种设备。',
    specs: {
      '处理器': 'ARM Cortex-A7 四核, 1.3GHz',
      'MCU': 'ARM Cortex-M4 32-bit',
      '内存': '512MB DDR3',
      '存储': '8GB eMMC',
      '无线': 'WiFi 802.11b，蓝牙 5.0',
      '4G': 'LTE Cat1 FDD，支持多频段；GSM 850/900/1800/1900 MHz',
      'PLC': 'P1901.1，支持 OFDM/FSK 调制',
      '串口': '2 × 带隔离 RS485',
      'CAN': '2 × 带隔离 CAN',
      '网口': '1 × 10/100M RJ45',
      'CT 环输入': '3 路',
      ...
      '按键': '6 个功能键 + 1 个 Reset',
      '指示灯': '3 色 LED（红/黄/绿）',
      '温湿度检测': '0～100%RH；-40～125°C',
      '供电': 'AC 230～380V，50～60Hz',
      '功耗': '≤ 10W',
      '工作温度': '-25°C ~ +55°C',
      '湿度': '25%～85%（无凝露）',
      '尺寸': '103 × 150 × 66.5 mm',
  ...
  },
  {
    ...
    tagline: '搭配 ATP III 充电桩，全自动智能调节充电功率，一步解决跳闸问题',
    category: 'hardware',
    description: 'Neuron III Lite 是专为搭配 ATP III 家用充电桩设计的智能防跳闸控制器，自带电表功能，全自动智能调节充电功率，兼容多协议，多桩协同充电，无需改动原有家庭电路，低成本快速部署。',
    specs: {
      'MCU': 'ARM Cortex-M4 32-bit',
      '无线': '2.4GHz WiFi，蓝牙 4.2 BR/EDR + BLE',
      'PLC': 'P1901.1，支持 OFDM/FSK 调制',
      '电能监测': '电压、电流、功率监测',
      'CT 环输入': '1 路',
      '按键': '1 个电流档设置键 + 1 个 Reset',
      '指示灯': '6 × 单色 LED（绿），1 × RGB LED',
      '供电': 'AC 230V，50Hz',
      '功耗': '≤ 10W',
      '工作温度': '-25°C ~ +55°C',
      '湿度': '25%～85%（无凝露）',
      '尺寸': '72 × 100 × 68 mm',
      '搭配产品': 'ATP III 7kW 家用交流充电桩',
    },
    scenarios: ['evcms'],
