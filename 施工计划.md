...
> 规则：完成当前Phase所有任务 → 跑对应测试用例 → 全部通过 → 才能进入下一Phase。

## 阶段总览

| Phase | 名称 | 测试用例 | 状态 |
|-------|------|----------|------|
| 0 | 项目初始化 + 基础架构 | 基础架构验证 | ⬜ 未开始 |
| 1 | 前台页面开发 | TC-F01~F60（60条） | ⬜ 未开始 |
| 2 | 全局功能 | TC-G01~G30（30条） | ⬜ 未开始 |
| 3 | SEO / Metadata | TC-S01~S20（20条） | ⬜ 未开始 |
| 4 | CMS 后台 | TC-C01~C42（42条） | ⬜ 未开始 |
| 5 | 表单与通知 | TC-N01~N15（15条）+ TC-A01~A20（20条，API集成测试） | ⬜ 未开始 |
| 6 | 性能优化 | TC-P01~P10（10条） | ⬜ 未开始 |
| 7 | 安全加固 | TC-T01~T15（15条） | ⬜ 未开始 |
