...
export interface ApiCaseCase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    solutionType: Schema.Attribute.String;
...
export interface ApiCompatibleBrandCompatibleBrand
  extends Struct.CollectionTypeSchema {
  collectionName: 'compatible_brands';
  info: {
    displayName: '\u517C\u5BB9\u54C1\u724C';
    pluralName: 'compatible-brands';
    singularName: 'compatible-brand';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::compatible-brand.compatible-brand'
    > &
      Schema.Attribute.Private;
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cfToken: Schema.Attribute.String;
    company: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    intentType: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNotificationConfigNotificationConfig
  extends Struct.CollectionTypeSchema {
  collectionName: 'notification_configs';
  info: {
    displayName: '\u901A\u77E5\u914D\u7F6E';
    pluralName: 'notification-configs';
    singularName: 'notification-config';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    emailTo: Schema.Attribute.String;
    isEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::notification-config.notification-config'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiProductRelationProductRelation
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_relations';
  info: {
    displayName: '\u4EA7\u54C1\u5173\u8054\u914D\u7F6E';
    pluralName: 'product-relations';
    singularName: 'product-relation';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-relation.product-relation'
    > &
      Schema.Attribute.Private;
    productSlug: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    showOnProduct: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showOnSolution: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    solutionSlug: Schema.Attribute.String & Schema.Attribute.Required;
    sortOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRepairTicketRepairTicket
  extends Struct.CollectionTypeSchema {
  collectionName: 'repair_tickets';
  info: {
    displayName: '\u62A5\u4FEE\u5DE5\u5355';
    pluralName: 'repair-tickets';
    singularName: 'repair-ticket';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    faultDesc: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::repair-ticket.repair-ticket'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    phone: Schema.Attribute.String;
...
export interface ApiSeoConfigSeoConfig extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::notification-config.notification-config': ApiNotificationConfigNotificationConfig;
      'api::page-content.page-content': ApiPageContentPageContent;
      'api::product-relation.product-relation': ApiProductRelationProductRelation;
